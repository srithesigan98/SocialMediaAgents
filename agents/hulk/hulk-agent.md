...
[`agents/hulk/`](./) — the folder this file lives in.
...
8. **Some posts pair with a poster — selectively.** Listicles, standalone aphorisms, and dense
   ...
   candlestick motif — see `agents/design/poster-style-guide.md` in the repo);
...
[`playbook/creator-research.md`](./playbook/creator-research.md)
and
[`creator-research-pass2.md`](./playbook/creator-research-pass2.md):
