#!/usr/bin/env python3
"""Renders a Hulk poster locally with Pillow — no Canva account/API needed.

Matches the locked style spec in ../../design/poster-style-guide.md (shared with Blue Hulk):
...
GitHub URL to Threads, since the Threads API requires a publicly reachable image URL and does
not accept local file uploads.
